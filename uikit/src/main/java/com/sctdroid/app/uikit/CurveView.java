...
//        mBackgroundPaint.setColor(mFillColor);
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mCoordinateColor = a.getColor(R.styleable.Curve_xyCoordinateColor, Color.BLACK);
            mStrokeWidth = a.getDimensionPixelSize(R.styleable.Curve_strokeWidth, 10);
            mCoordinateWidth = a.getDimensionPixelSize(R.styleable.Curve_coordinateWidth, 10);
            ...
            mMinLevel = a.getInteger(R.styleable.Curve_minLevel, 0);
            mMaxLevel = a.getInteger(R.styleable.Curve_maxLevel, 0);
